...
namespace SpatialPartitionPattern
{
    public class Grid
    {
        ...
        //Each indiviual soldier links to other soldiers in the same cell
        Soldier[,] cells;
        ...
        public void Add(Soldier soldier)
        {
            ...
            {
                //Set this soldier to be the previous soldier of the next soldier of this soldier (linked list ftw)
